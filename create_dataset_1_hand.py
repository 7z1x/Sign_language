...
# PENTING: Atur max_num_hands=1 untuk memastikan konsistensi data
hands = mp_hands.Hands(static_image_mode=True, max_num_hands=1, min_detection_confidence=0.3)

DATA_DIRS = ['./dataset_1_tangan', './fahmi']
...
# Loop melalui setiap direktori kelas
    for dir_name in os.listdir(DATA_DIR):
        ...
        for img_name in os.listdir(dir_path):
            ...
            # PENTING: Hanya proses data jika tangan terdeteksi
            if results.multi_hand_landmarks:
                # Karena max_num_hands=1, kita bisa langsung ambil elemen pertama
                hand_landmarks = results.multi_hand_landmarks[0]
                
                # Ekstraksi koordinat x dan y
                ...
                # Tambahkan data dan label yang sudah diproses
