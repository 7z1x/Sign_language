...
# PENTING: Atur max_num_hands=2 untuk mendeteksi dua tangan
...
for dir_name in os.listdir(DATA_DIR):
    ...
    for img_name in os.listdir(dir_path):
        ...
        # PENTING: Hanya proses jika terdeteksi TEPAT DUA TANGAN
        if results.multi_hand_landmarks and len(results.multi_hand_landmarks) == 2:
            data_aux = []
            x_ = []
            y_ = []
            
            # Buat list untuk semua 42 landmark (21 dari tangan kiri + 21 dari tangan kanan)
            all_landmarks = []
            # Urutkan tangan berdasarkan 'Left' atau 'Right' untuk konsistensi
            ...
            if 'Left' in handedness_list and 'Right' in handedness_list:
                # Jika ada kiri dan kanan, urutkan: Kiri dulu, baru Kanan
            ...
            # Tambahkan data 84 fitur dan labelnya
